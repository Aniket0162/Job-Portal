            ...
            <nav className="navbar bg-dark sticky-top navbar-expand-lg bg-body-tertiary" data-bs-theme="dark" >
                <div className="container-fluid" >
                    <div style={{height:'3rem',width:'3rem', borderRadius:'50%',overflow: 'hidden', boxShadow: '2px 2px 2px gray', border:'2px solid white'}}>
                        ...
                        <img src={`${process.env.PUBLIC_URL}/Logo2.png`} style={{height:'4rem',width:'4rem',backgroundSize:'cover',backgroundPosition:'top left', transform:'translateY(-13%)',transform:'translateX(-10px)',backgroundRepeat:'no-repeat',margin:'0' }} alt="Job Dekho"/>       
                    </div>
